...
void init_cube() {
  ...
  mesh[0].p[0] = (vec3){0.0f, 0.0f, 0.0f};
  mesh[0].p[1] = (vec3){0.0f, 1.0f, 0.0f};
  mesh[0].p[2] = (vec3){1.0f, 1.0f, 0.0f};
  mesh[1].p[0] = (vec3){0.0f, 0.0f, 0.0f};
  mesh[1].p[1] = (vec3){1.0f, 1.0f, 0.0f};
  mesh[1].p[2] = (vec3){1.0f, 0.0f, 0.0f};
  mesh[2].p[0] = (vec3){1.0f, 0.0f, 0.0f};
  mesh[2].p[1] = (vec3){1.0f, 1.0f, 0.0f};
  mesh[2].p[2] = (vec3){1.0f, 1.0f, 1.0f};
  mesh[3].p[0] = (vec3){1.0f, 0.0f, 0.0f};
  mesh[3].p[1] = (vec3){1.0f, 1.0f, 1.0f};
  mesh[3].p[2] = (vec3){1.0f, 0.0f, 1.0f};
  mesh[4].p[0] = (vec3){1.0f, 0.0f, 1.0f};
  mesh[4].p[1] = (vec3){1.0f, 1.0f, 1.0f};
  mesh[4].p[2] = (vec3){0.0f, 1.0f, 1.0f};
  mesh[5].p[0] = (vec3){1.0f, 0.0f, 1.0f};
  mesh[5].p[1] = (vec3){0.0f, 1.0f, 1.0f};
  mesh[5].p[2] = (vec3){0.0f, 0.0f, 1.0f};
  mesh[6].p[0] = (vec3){0.0f, 0.0f, 1.0f};
  mesh[6].p[1] = (vec3){0.0f, 1.0f, 1.0f};
  mesh[6].p[2] = (vec3){0.0f, 1.0f, 0.0f};
  mesh[7].p[0] = (vec3){0.0f, 0.0f, 1.0f};
  mesh[7].p[1] = (vec3){0.0f, 1.0f, 0.0f};
  mesh[7].p[2] = (vec3){0.0f, 0.0f, 0.0f};
  mesh[8].p[0] = (vec3){0.0f, 1.0f, 0.0f};
  mesh[8].p[1] = (vec3){0.0f, 1.0f, 1.0f};
  mesh[8].p[2] = (vec3){1.0f, 1.0f, 1.0f};
  mesh[9].p[0] = (vec3){0.0f, 1.0f, 0.0f};
  mesh[9].p[1] = (vec3){1.0f, 1.0f, 1.0f};
  mesh[9].p[2] = (vec3){1.0f, 1.0f, 0.0f};
  mesh[10].p[0] = (vec3){1.0f, 0.0f, 1.0f};
  mesh[10].p[1] = (vec3){0.0f, 0.0f, 1.0f};
  mesh[10].p[2] = (vec3){0.0f, 0.0f, 0.0f};
  mesh[11].p[0] = (vec3){1.0f, 0.0f, 1.0f};
  mesh[11].p[1] = (vec3){0.0f, 0.0f, 0.0f};
  mesh[11].p[2] = (vec3){1.0f, 0.0f, 0.0f};
}
...
void update_cube(triStack *stack) {
  ...
  for (i = 0; i < meshSize; i++) {
    ...
    triTranslated = tri;
    for (j = 0; j < 3; j++) {
      triTranslated.p[j].z = tri.p[j].z + 8.0f;
    }
